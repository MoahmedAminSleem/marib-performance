...
var App = (function () {
  ...
  function entOpenProdForm() {
    ...
    entOpenForm(T("ent_add") + " — " + T("ent_prod_tab"), html, function () {
      var data = {
        date: entModal.querySelector("#efDate").value,
        po_number: entModal.querySelector("#efPo").value,
        qty: parseInt(entModal.querySelector("#efQty").value, 10) || 0,
        note: entModal.querySelector("#efNote").value,
      };
  ...
  function entOpenAbsForm() {
    ...
    entOpenForm(T("ent_add") + " — " + T("ent_abs_tab"), html, function () {
      var data = {
        date: entModal.querySelector("#efDate").value,
        emp_code: entModal.querySelector("#efCode").value.trim(),
        emp_name: entModal.querySelector("#efName").value.trim(),
        reason: entModal.querySelector("#efReason").value.trim(),
      };
  ...
  function entSubmitAbsImport(rows) {
    ...
    entOpenForm(T("ent_upload_tpl"), html, function () {
      var date = entModal.querySelector("#efDate").value;
      if (!date) { toast(T("toast_fill"), "err"); return false; }
      var formModal = entModal.querySelector(".ent-form-modal");
  ...
  function entOpenOtForm() {
    ...
    var html =
      ...
      '<div class="ent-form-row"><label>' + esc(T("ent_note")) + '<input type="text" id="efNote" placeholder=""></label></div>';
    entOpenForm(T("ent_add") + " — " + T("ent_ot_tab"), html, function () {
      var data = {
        date: entModal.querySelector("#efDate").value,
        emp_code: entModal.querySelector("#efCode").value.trim(),
        emp_name: entModal.querySelector("#efName").value.trim(),
        hours: parseFloat(entModal.querySelector("#efHours").value) || 0,
        note: entModal.querySelector("#efNote").value.trim(),
      };
  ...
  function init() {
    ...
    /* R44: topbar mini logos (main page only) — settings / data / users / entries */
